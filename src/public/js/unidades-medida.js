async function Listar() {
    let data=await unidades_medida.lista();
...
async function Nuevo(){
    ...
    if (value) {
        const respuesta=await unidades_medida.agregar(value);
        if(respuesta){
            Listar()
...
async function Editar(id){
    const obj=await unidades_medida.buscar(id)
    ...
    if (value) {
        const respuesta=await unidades_medida.editar(value);
        if(respuesta){
            Listar()
...
async function Eliminar(id){
    ...
    if (value) {
        const respuesta=await unidades_medida.eliminar(id);
        if(respuesta){
            Listar()
